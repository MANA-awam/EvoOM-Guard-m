...
Install the signing extra and generate an Ed25519 key once. `v4.0.2` is the
published immutable GitHub Release:

```bash
pip install "evoom-guard[sign] @ git+https://github.com/EvoRiseKsa/EvoOM-Guard-m.git@v4.0.2"
