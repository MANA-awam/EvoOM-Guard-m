...
- uses: EvoRiseKsa/EvoOM-Guard-m@v3.5.2   # a release tag; @<sha> is strictest, @main is latest
```
...
> pip URL:
> - **`@v3.5.2`** — a release tag. The recommended pin and the right choice for
...
`EvoRiseKsa/EvoOM-Guard-m@v3.5.2`. Copy [`examples/evoguard.yml`](../examples/evoguard.yml) to
